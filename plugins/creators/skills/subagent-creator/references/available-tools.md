...
Sub-agents can be granted access to any of Claude Code's internal tools.
If `tools` field is omitted, the sub-agent inherits all tools from the main thread.
...
Sub-agents can also access tools from configured MCP servers.
