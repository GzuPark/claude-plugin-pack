...
Common mistakes to avoid when creating sub-agents.
...
Giving more tools than necessary increases risk and reduces focus.

```yaml
# Bad - omitting tools gives ALL tools
---
name: log-analyzer
description: Analyzes log files
---

# Good - only tools actually needed
---
name: log-analyzer
description: Analyzes log files
...
### 3. Missing Permission Mode for Risky Tasks

Dangerous tasks without appropriate permission restrictions.

```yaml
# Bad - full permissions for potentially destructive task
---
name: cleanup-agent
...
### 4. No Clear Invocation Steps

Missing instructions for what to do when triggered.
...
You are a code pattern analyzer.

When invoked:
1. Identify the target files or directories
2. Scan for specified patterns
...
Using expensive models for simple tasks, or weak models for complex reasoning.

```yaml
# Bad - opus for simple formatting
---
name: json-formatter
model: opus
---
...
# Bad - haiku for complex security analysis
---
name: security-auditor
model: haiku
---

# Good - sonnet or opus for complex reasoning
---
name: security-auditor
model: sonnet
permissionMode: plan
